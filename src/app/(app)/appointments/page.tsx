    ...
    <div className="w-full">
      ...
      <div className="gap-32 mt-16 mx-12 mb-6 rounded-xl">
        <Card className="p-8 bg-[#c6aff6]">
          <CardContent className="p-0">
            <h1 className="text-3xl text-white text-center font-bold">
              Выберите услугу и клинику
            </h1>
            <p className="text-white text-lg pt-4 pb-8 pl-3 font-normal">
              Все доктора Вашего города есть в <span className='text-[#77deb5]'>Сбер</span>Бинт
            </p>
            <div className="flex justify-center items-center w-full gap-4">
              <Input disabled={false} placeholder="Начните вводить название услуги" className='border-2 text-lg h-12' />
              <Input disabled={false} placeholder="Начните вводить название клиники" className='border-2 text-lg h-12' />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="p-6 bg-white mt-6">
          <CardContent className="p-0">
            <h1 className="text-4xl text-[#26364b] font-bold ml-7">
              Популярные специальности
            </h1>
            <div className='mt-3 flex gap-x-16 gap-y-10 max-w-full flex-wrap overflow-y-auto max-h-[425px] justify-center items-center'>
              <Link
